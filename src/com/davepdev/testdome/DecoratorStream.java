 ...
 * 
 * @author davepdev
 * score: 0% - bitwise operators, array of bytes... yikes!
 *        did not get far with this one.
 ...
 * For example, if the DecoratorStream is instantiated with "First line: " as the prefix 
 * parameter and write method is called with UTF-8 byte representation of "Hello, world!", it should write "First line: Hello, world!" into the underlying stream.
 */
    ...
    public DecoratorStream(OutputStream stream, String prefix) {
        ...
        if (prefix != null) {
           ...
           // OutputStream tmp = new OutputStream();
            		...
            		//prefix.toString() + ": " + stream.toString();
